<?php 
	...
	Class Image {
		...
		public static function en_captcha($n = 4,$font=20,$imgWidth=200,$imgHeight=60){
			...
			for($i=1;$i<=$n;$i++){
				...
				imagettftext($img, $font, mt_rand(-30,60), $x, $y, $fontColor, "arial.ttf", $str[$i-1]);
			}
	...
	public static function zh_captcha($n = 4,$font=20,$imgWidth=200,$imgHeight=60){
		...
		for($i=1;$i<=$n;$i++){
			...
			// imagestring($img, $font, $x, $y, $str[$i-1], $fontColor);
			// imagettftext(画布, 字体大小(像素), 角度, 开始的x, 开始y, 颜色, "字体文件", 字符串)
			imagettftext($img, $font, mt_rand(-30,60), $x, $y+5, $fontColor, "msyh.ttc", $str[$i-1]);
		}
